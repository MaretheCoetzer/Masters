...
int input=2;
int end_time=0;
int time_step=150000; // WAS 200 000
int steps = 39;
// int steps[] = {0,6,14,26,34,39}; // set the node at which the robot should stop, then manually increase through the nodes and recompile, rinse and repeat.
int first_print=1;
