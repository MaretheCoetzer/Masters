...
logger.info(f"tibia: {TibiaLength}")
...
animate.save(path+gait_name+"_3D.gif", writer='PillowWriter', fps=10)
...
# m.h[i].value*hm*100000
animate.save(path+gait_name+"_XZ.gif", writer='PillowWriter', fps=10)
...
Properties.to_csv (path+gait_name+"_3D_Properties.csv", index = False, header=True)
...
Torques.to_csv (path+gait_name+"_3D_Nodal.csv", index = False, header=True)
...
Movement_traj.to_csv (path+gait_name+"_3D_col_traj.csv", index = False, header=True)
...
Movement_ros.to_csv (path+gait_name+"_3D_col_ros.csv", index = False, header=True)
