...
def step_distance_1_max(m,n,c):       
    ...
    if (n==N/8):
        return lamb_foot1x(*var_list) <=distance_from_step+clearance
    if (n==2*N/8):
        return lamb_foot1x(*var_list) <=distance_from_step+step_length
    return Constraint.Skip
...
properties = {'N':[N],'Body Mass':[m.m[('body',1)]],'Femur 1 Mass':[m.m[('femur',1)]],'Tibia 1 Mass':[m.m[('tibia',1)]],'Femur 2 Mass':[m.m[('femur',2)]],
                                    ...
                                    'Femur 3 Length':[m.l[('femur',3)]],'Tibia 3 Length':[m.l[('tibia',3)]],'Femur 4 Length':[m.l[('femur',4)]],'Tibia 4 Length':[m.l[('tibia',4)]],'Step height':[stair_height], 'Step lenght':[step_length],'Distance from step':[distance_from_step]}
